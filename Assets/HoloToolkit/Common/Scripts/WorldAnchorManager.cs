...
namespace HoloToolkit.Unity
{
    ...
    public class WorldAnchorManager : Singleton<WorldAnchorManager>
    {
        ...
        {
            string anchorId = anchorAttachmentInfo.AnchorName + "_" + DateTime.Now.ToString("hh.mm.ss.ffffff");
            ...
            switch (anchorAttachmentInfo.Operation)
            {
                case AnchorOperation.Save:
                    ...
                    {
                        //increase anchorId
                        anchorId = anchoredGameObject.name + "_" + DateTime.Now.ToString("hh.mm.ss.ffffff");
                    }

                    // Try to load a previously saved world anchsor.
        ...
        private void CreateAnchor(GameObject gameObjectToAnchor, string anchorName)
        {
            ...
            anchor.name = anchorName + "_" + DateTime.Now.ToString("hh.mm.ss.ffffff").ToString();
